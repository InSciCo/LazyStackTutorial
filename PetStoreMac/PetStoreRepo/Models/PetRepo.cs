...
namespace PetStoreRepo.Models
{
    ...
    public class PetRepo : DYDBRepository<DefaultEnvelope, PetHelper, Pet>, IPetRepo
    {
        ...
        public async Task<ActionResult<Pet>> PingAsync()
        {
            ...
            return new OkObjectResult(
                new Pet()
                {
                    ...
                    Tags = new List<PetStoreMacSchema.Models.Tag> { tagRepo.Tags[1] },
        ...
        public  async Task<ActionResult<ICollection<PetStoreMacSchema.Models.Tag>>> GetPetTagsAsync()
        {
            await Task.Delay(0);
        ...
        public async Task<IActionResult> SeedPetsAsync()
        {
            ...
            var pet = new Pet()
            {
                ...
                Tags = new List<PetStoreMacSchema.Models.Tag> { tagRepo.Tags[1], tagRepo.Tags[2] },
                PetStatus = PetStatus.Available
            };
            ...
            pet = new Pet()
            {
                ...
                Name = "Sweetie",
                PhotoUrls = new List<string> { "www.example.com" },
                Tags = new List<PetStoreMacSchema.Models.Tag> { tagRepo.Tags[1], tagRepo.Tags[2], tagRepo.Tags[3] },
                PetStatus = PetStatus.Available
            };

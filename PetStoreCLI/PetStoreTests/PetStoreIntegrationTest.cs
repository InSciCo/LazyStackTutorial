...
namespace PetStoreTests
{
    ...
    public class PetStoreIntegrationTest
    {
        ...
        public async Task TestMethod1()
        {
            ...
            using var methodMapStream = typeof(PetStoreCLI).Assembly.GetManifestResourceStream("PetStoreCLIClientSDK.MethodMap.json");
            ...
            var petStore = new PetStoreCLI(lzHttpClient);
